...
print(f"awsAccessKey: {aws_access_key_id}")
print(f"awsSecretKey: {aws_secret_access_key}")
print(f"regionName: {region_name}")
...
if log_group_name and log_stream_name and aws_access_key_id and aws_secret_access_key and region_name:
    logs = get_logs(log_group_name, log_stream_name, region_name, aws_access_key_id, aws_secret_access_key)
    print(logs)
else:
    print("Missing one or more required form fields.")
